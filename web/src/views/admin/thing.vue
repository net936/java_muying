        ...
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="适用人群" name="shiyong">
                  <a-input placeholder="请输入" v-model:value="modal.form.shiyong" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="包装形式" name="bz">
                  <a-input placeholder="请输入" v-model:value="modal.form.bz" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('bz', modal.form.bz || '');
